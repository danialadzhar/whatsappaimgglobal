                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">Create a new product for your catalog</p>
                            </div>
                                    ...
                                    <form @submit.prevent="submitColor" class="space-y-4">
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-1">Color
                                                Name</label>
                                            <input v-model="colorForm.name"
                                                @input="colorForm.name = (colorForm.name || '').toUpperCase()"
                                                placeholder="Contoh: Black" type="text" required
                                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent uppercase" />
                                        </div>
                                        <div class="flex justify-end gap-3 pt-4">
                                    ...
                                    <form @submit.prevent="submitStorage" class="space-y-4">
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-1">Storage
                                                Size</label>
                                            <input v-model="storageForm.name"
                                                @input="storageForm.name = (storageForm.name || '').toUpperCase()"
                                                placeholder="Contoh: 256GB" type="text" required
                                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent uppercase" />
                                        </div>
                                        <div class="flex justify-end gap-3 pt-4">
...
const submitColor = async () => {
    const name = (colorForm.value.name || '').trim().toUpperCase();
    if (!name) return;
    try {
...
const submitStorage = async () => {
    const name = (storageForm.value.name || '').trim().toUpperCase();
    if (!name) return;
    try {
