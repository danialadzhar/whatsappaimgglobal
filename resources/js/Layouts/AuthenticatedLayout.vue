                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <button class="ml-auto p-1 hover:bg-gray-100 rounded">
                            <svg class="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8V4a1 1 0 011-1h4M4 8l4-4m0 0v4M4 8h4m6-4h4a1 1 0 011 1v4m0 0l-4-4m4 0v4m0 4l-4 4m4 0h-4m0 0v-4m0 4v4a1 1 0 01-1 1h-4"></path>
                            </svg>
                        </button>
                    </div>
                </div>
                    ...
                    <div class="px-3">
                        ...
                        <nav class="mt-2 space-y-1">
                            <Link
                                ...
                                :key="item.name"
                                :href="item.href === 'dashboard' ? route(item.href) : item.href"
                                :class="[
                                    item.active
                            ...
                            <template #trigger>
                                <button class="max-w-xs bg-white flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                    ...
                                    <div class="h-8 w-8 rounded-full bg-gray-300 flex items-center justify-center">
                                        <span class="text-sm font-medium text-gray-700">{{ $page.props.auth.user.name.charAt(0) }}</span>
                                    </div>
                                </button>
                            </template>
                            <template #content>
